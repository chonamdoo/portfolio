...
`red → green → refactor`가 절차에 박혀 있습니다. TDD를 권장이 아니라 통과 조건으로 만든
...
- **팀원마다 다른 숙련도** — 절차를 이해하고 쓰는 사람과, 막히는 지점에서 우회로를 찾는
  사람에게 같은 검사 단계가 같은 의미인지 확인하지 못했습니다.
- **속도와 신뢰의 맞바꿈** — 검사 단계가 많아 혼자 쓸 땐 감당되지만, 팀에 넣으면 "왜
  이렇게 오래 걸리냐"는 반발이 먼저 옵니다. 어느 정도 느려지는 것까지 받아들일지 기준이
  없습니다.
